...
![300](./images/Pasted%20image%2020231013112331.png)
...
If you have an image that is 1000x1000, then after flattening it, you would get an input vector of 10^6 (11 million) parameters. If you then opt to have a hidden layer of the same size as the previous layer, you have a hidden layer comprising 10^6 parameters, and each neuron is fully connected to every preceding neuron, resulting in 10^6 x 10^6 parameters in total for that hidden layer. This quantity of parameters is extensive to store in conventional computers and represents just one layer, posing a scalability issue.
	![300](./images/Pasted%20image%2020231013113239.png)
...
![300](./images/Pasted%20image%2020231013113620.png)
...
![300](./images/Pasted%20image%2020231013150005.png)
...
![300](./images/Pasted%20image%2020231030143800.png)
...
![300](./images/Pasted%20image%2020231027223453.png)
...
![300](./images/Pasted%20image%2020231027223729.png)
...
![300](./images/Pasted%20image%2020231027223928.png)
Experiment: epochs=20; lr=0.00001, batch_size=128
![300](./images/Pasted%20image%2020231027224138.png)
...
![300](./images/Pasted%20image%2020231027224604.png)
...
![300](./images/Pasted%20image%2020231027230737.png)
...
![300](./images/Pasted%20image%2020231027231300.png)
...
![300](./images/Pasted%20image%2020231021171542.png)
...
![300](./images/Pasted%20image%2020231027132228.png)
...
Experiment: batch_size=128, lr=0.1, epochs=50, cuda=True
![300](./images/Pasted%20image%2020231027134641.png)
...
![300](./images/Pasted%20image%2020231030183306.png)
...
Experiment: batch_size=128, lr=0.1, epochs=50, cuda=True
![300](./images/Pasted%20image%2020231027182339.png)
...
![300](./images/Pasted%20image%2020231027141209.png)
...
![300](./images/Pasted%20image%2020231027142024.png)
...
Experiment: batch_size=128, lr=0.1, epochs=50, cuda=True
![300](./images/Pasted%20image%2020231029162452.png)
...
Experiment: batch_size=128, lr=0.1, epochs=50, cuda=True
![300](./images/Pasted%20image%2020231027181232.png)
...
![300](./images/Pasted%20image%2020231030233513.png)
...
Experiment: batch_size=128, lr=0.1, epochs=50, cuda=True
![300](./images/Pasted%20image%2020231030235949.png)
...
Experiment: batch_size=128, lr=0.1, epochs=50, cuda=True
![300](./images/Pasted%20image%2020231027183751.png)
...
![300](./images/Pasted%20image%2020231027210731.png)
...
![300](./images/Pasted%20image%2020231027213348.png)
...
Experiment: batch_size=128, lr=0.1, epochs=100, cuda=True
![300](./images/Pasted%20image%2020231031004747.png)
